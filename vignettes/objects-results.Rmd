...
params:
  ...
  content_width: 72
vignette: >
  %\VignetteIndexEntry{Objects and results}
...
`cluster`), `clusvol`, `centers`, `coord_centers`, `actual_k` (with alias
`n_clusters`), `label_ids`, `method`, `parameters`, typed `provenance`, and
