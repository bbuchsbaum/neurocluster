...
The package provides a unified
...
6.  **ACSC** (Adaptive Correlation Superclustering,
    [`acsc()`](https://bbuchsbaum.github.io/neurocluster/reference/acsc.md)
    in `R/acsc.R`)
...
7.  **Meta-clustering**
    ([`meta_clust()`](https://bbuchsbaum.github.io/neurocluster/reference/meta_clust.md)
    in `R/meta_clust.R`)
    - Hierarchical clustering of cluster results
    - Consensus clustering via
      [`merge_clus()`](https://bbuchsbaum.github.io/neurocluster/reference/merge_clus.md)
      functions
...
4.  **Hybrid R+C++**: Keep R for flexibility, C++ for bottlenecks
    ...
    - Always provide R fallback (e.g.,
      [`refine_voxel_boundaries_r()`](https://bbuchsbaum.github.io/neurocluster/reference/refine_voxel_boundaries_r.md))
...
- Coordinate conversion via `index_to_coord()` and
  [`index_to_grid()`](https://bbuchsbaum.github.io/neurocluster/reference/index_to_grid.md)
  (from neuroim2)
- Spatial gradient computation in `R/gradient.R` using neighbor weights
- Tessellation via k-means on spatial coordinates
  ([`tesselate()`](https://bbuchsbaum.github.io/neurocluster/reference/tesselate.md))
