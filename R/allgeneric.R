...
#' @param ... Additional clustering results to be merged and method-specific arguments
#'   (e.g., \code{method} for consensus algorithm selection).
#'
#' @return A \code{\link[neuroim2:ClusteredNeuroVol-class]{ClusteredNeuroVol}} instance.
#'
#' @examples
#' \dontrun{
