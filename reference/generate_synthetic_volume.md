...
- pattern_type:
  ...
  Type of temporal patterns to generate. One of `"orthogonal"`
  (QR-decomposition for maximally distinct signals, default),
  `"harmonic"` (phase/frequency-shifted sinusoids), or `"random"`
  (random linear combinations of harmonics).
...
str(syn)
#> List of 10
#>  $ vec         :Formal class 'DenseNeuroVec' [package "neuroim2"] with 4 slots
#>   .. ..@ .Data        : num [1:12, 1:12, 1:6, 1:30] -0.336 -0.438 -0.517 -0.414 -0.399 ...
#>   .. ..@ label        : chr "none"
#>   .. ..@ volume_labels: chr(0) 
