...
2D/3D mask with three spatial bands (left/mid/right) and clearly
...
- seed:
  ...
  Optional integer seed for reproducibility. Default `NULL` (no change).
...
- truth:
  ...
  Integer ground-truth labels (length = prod(dims))
