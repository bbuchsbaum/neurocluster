...
- [`snic()`](https://bbuchsbaum.github.io/neurocluster/reference/snic.md)
  is single-pass with low memory overhead.
...
elapsed <- c(
  snic = run_and_time("snic", function() snic(
    toy$vec, toy$mask, K = 3, compactness = 3
  )),
...
data.](speed-parallel_files/figure-html/fig-runtime-1.png)
