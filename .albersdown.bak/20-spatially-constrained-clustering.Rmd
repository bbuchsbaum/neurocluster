...
- Supervoxels: `alpha` is feature weight; spatial weight = `1 - alpha`.
- SNIC/SLIC: `compactness` maps to spatial emphasis; in `cluster4d`, use `spatial_weight`.

# Connectivity {#connectivity}
- 6 vs 26 neighbors: higher connectivity generally yields smoother parcels.
